...
?>
	...
	<div id="mainContent">
		<div id="content">
			...
			<br/>
			<h2>MISSION</h2>
			<p>Enable individuals and organizations to identify and reach their desired goals.</p><br/>
...
backgrounds</li>
					<li>Visionary based upon life-long learning and continual scanning of multiple and diverse environments
</li>
...
integrated focus on "what" boards do and "how" they work most effectively as a team.</li>
			...
			<br/>
			<h2>PROFESSIONAL EXPERIENCE - PAST</h2>
...
million, known throughout the community for program and administrative excellence.</li>
      ...
      <h5>Assistant Professor, University of Texas Graduate School of Social Work</h3>
			...
			<h5>Coordinator, VISTA Training Center, Pillsbury Neighborhood Services, Minneapolis, MN.</h5>
      <br/>
			<h2>EDUCATION</h2>
      ...
      <br/>
			...
			<p>Many governing boards and leadership positions</p><br/>

			<h2>PUBLICATIONS</h2>
			<ul class="bodyBullets">
			  <li>
			    <em>Loring Nicollet-Bethlehem Community Centers 1954-2008: A Lively History</em> (Created by Laura Ayers &amp; Jim Storm on behalf of the Project for Pride in Living as a celebration of its merger with LNB)<br />
        ...
        <li>
          <em>Minneapolis Federation of Alternative Schools: Program and Organizational Development, 1993</em>
        </li>
			</ul>
		</div>	<!-- END CONTENT -->
