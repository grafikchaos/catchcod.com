...
<script type="text/javascript" src="/javascript/changeQuotes.js"></script>
...
?>
		<div class="sidebarnotes">
			...
			<div class="sidebarNote">
				<p>Could you and your organization benefit from a better understanding of organizational governance? <a href="redbus.php">We have a ticket for you</a> on the <a href="redbus.php">Little Red Bus</a>.</p>
			</div>
		</div>
<?php
}
...
?>
		<div class="sidebarnotes">
			<img class="floatleft" src="/images/bookCover.jpg" alt="Book cover of: Master of Creative Philanthropy: The Story of Russel V. Ewald" />
			<div class="sidebarNote">
				<p>
