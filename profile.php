...
<div id="mainContent">
    <div id="content">
        ...
        <img class="floatleft" src="<?php echo getBaseUrl(); ?>images/jim.jpg" alt="Jim Storm, Ph.D." width="150" height="218"  />

        <p>
          <em>Forbes</em> magazine has described Jim as a &quot;charity scout&quot; based on his philanthropic work with wealthy families and individuals.
        </p>
        <p>
        ...
        <ul class="bodyBullets">
            <li>Outstanding reputation in the fields of philanthropic consultation, organizational development and organizational leadership</li>
            <li>Ph.D. with a focus on organizational development, having interacted with the icons of philanthropy, leadership and organizational development</li>
            <li>Integrates extensive hands-on experience with in-depth understanding of organizational and individual growth and development</li>
            <li>Exceptional ability to distill clarity from complexity</li>
            <li>Keen listening skills enable him to guide others in the identification of their goals and the establishment of action steps to reach those goals</li>
            <li>Experienced in working with diverse clients, including:<br />
                <ul class="bodyBullets">
                    <li><em>Forbes</em> 400 individuals</li>
        ...
        <br/>
        <p>View <a href="<?php echo getBaseUrl(); ?>resume.php">Jim's Resum&eacute;</a></p>
