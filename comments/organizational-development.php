...
<div id="mainContent">
	<div id="content">
		<h1>Organizational Development Testimonials</h1>

		<p>The following are excerpts from comments received by COD:</p>

		<p class="quoteComment">
			<em>
				&quot;I have worked with Jim Storm, in a variety of situations, for several years. I treasure both
				his deep academic background and his experienced, professional demeanor. Jim enables members of a
				group to discuss an issue freely. Then, in a quiet manner, he moves the debate to a higher level
				with one or two questions which put the primary issue and alternative solutions into clear focus.
				Whenever Dr. Storm participates, I know we will emerge not only with new, creative ways to face
