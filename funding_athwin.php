...
<div id="mainContent">
	<div id="content">
        ...
        <p class='red lead'>Effective through December 20th, 2014</p>
        ...
        <h2 class='section-title'>II. Application Process</h2>
        <p>
            <strong>A. The Foundation takes into account a number of criteria</strong> when making funding decisions.
            Among the primary criteria are the following:
        </p>
        ...
        <ul class='bodyBullets'>
            ...
            <li>
                Completion or planned completion of an organizational assessment process, such as the
                Accountability Wizard offered by the Minnesota Charities Review Council.
            </li>
        </ul>
